...
/**
 * Window to add a new Sharp News item.
 */
public class NewSharpNewsWindow extends Window {

    private DynamicForm i_form;

    public NewSharpNewsWindow() {
        super();

        setWidth(500);
        setHeight(200);
        setTitle("Add SHARP News Item");
    ...
    private void addButtons() {
        ...
        IButton addButton = new IButton("Add SHARP News");
